...
from utils.ClassCLF import DOSAGE_CLF
...
if __name__ == '__main__':
    ...
    rnn_hidden = 32
    dropout = 0.1
    ae_model_path = 'models/AE_MED_PHYSIO/VASO-TCN-168hidden-0.1dropout-16-0.0005/version_3'        #"models/VASO_PHYSIO_PRED/CNN-196hidden-5-5-0.1dropout-16-0.0005/version_0/"

    model_name = f"{rnn_hidden}rnn-{dropout}dropout-{batchsize}-{lr}"
    ...
    if model_type == 'DOSAGE_CLF':
        model = DOSAGE_CLF(config).to(device)
    else:
