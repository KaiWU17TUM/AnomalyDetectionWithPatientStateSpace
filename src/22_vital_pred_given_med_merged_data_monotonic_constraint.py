...
from utils.ClassSOM import VASO_PHYSIO_PRED_MONO
...
if __name__ == '__main__':
    model_type = 'VASO_PHYSIO_PRED_MONO'
    ...
    config = {
        ...
        'cnn_out1': cnn_out1,
        'cnn_out2': cnn_out2,
        'cnn_kernel1': cnn_kernel1,
        'cnn_kernel2': cnn_kernel2,
        'cnn_stride1': cnn_stride1,
        'cnn_stride2': cnn_stride2,
        # MONO
    ...
    elif model_type == 'VASO_PHYSIO_PRED_MONO':
        model = VASO_PHYSIO_PRED_MONO(config).to(device)
    else:
