...
if __name__ == '__main__':
    ...
    #
    # # filter patient with an ICU stay betw. 1-14 days
    # pid_los = patient_info.loc[(patient_info['LOS']>=1) & (patient_info['LOS']<14), 'patientid'].tolist()
    # pid_valid = [pid for pid in pid_valid if pid in pid_los]
    # print(f"Remove patient with LOS less than 1 day or more than 14 days... --- {len(pid_valid)}")
    #
